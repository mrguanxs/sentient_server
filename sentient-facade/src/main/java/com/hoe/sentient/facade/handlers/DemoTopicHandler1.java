...
//@Component
//@Slf4j
//public class DemoTopicHandler1 extends AbstractTopicMessageEventHandler<DemoTopicEvent2> {
//
//    @Override
//    public void handle(DemoTopicEvent2 event) {
//        System.out.println("topic1:" + event.getName());
//    }
//
//    @Override
//    public List<String> getRoutingKeys() {
//        ArrayList<String> routingKeys = new ArrayList<>();
//        routingKeys.add("topic.*.def");
//        routingKeys.add("topic.abc.#");
//        return routingKeys;
//    }
//
//
